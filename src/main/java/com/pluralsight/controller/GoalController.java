...
public class GoalController {
    ...
    public String updateGoal(@Valid @ModelAttribute("goal") Goal goal, BindingResult result, HttpSession session) {

        System.out.println("result has errors: " + result.hasErrors());

        System.out.println("Goal set: " + goal.getMinutes());
        System.out.println("Session attribute goal: " + ((Goal) session.getAttribute("goal")).getMinutes());
